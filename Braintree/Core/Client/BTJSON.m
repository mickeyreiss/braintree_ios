...
- (id)copyWithZone:(NSZone *)zone {
    return [BTJSON JSONWithDictionary:[self.apiDictionary copyWithZone:zone]];
}
...
- (BTJSON *)responseParserForKey:(NSString *)key {
    return [BTJSON JSONWithDictionary:[self dictionaryForKey:key]];
}
...
- (BOOL)isEqual:(id)object {
    if ([object isKindOfClass:[BTJSON class]]) {
...
- (NSString *)debugDescription {
    return [NSString stringWithFormat:@"<BTJSON: %p %@>", self, [self.apiDictionary debugDescription]];
}
