...
- (void)appSwitcherWillCreatePaymentMethod:(id<BTAppSwitchHandling>)switcher;

@required

/// This message is sent when a payment method has been authorized and is available.
- (void)appSwitcher:(id<BTAppSwitchHandling>)switcher didCreatePaymentMethod:(BTPaymentMethod *)paymentMethod;

/// This message is sent when the payment method could not be created.
- (void)appSwitcher:(id<BTAppSwitchHandling>)switcher didFailWithError:(NSError *)error;

/// This message is sent when the payment was cancelled.
- (void)appSwitcherDidCancel:(id<BTAppSwitchHandling>)switcher;
